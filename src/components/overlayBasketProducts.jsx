...
export function OverlayBasketProducts() {
  // Récupère le panier (basket) et la fonction removeFromCart depuis le contexte CartContext
      ...
      >
        ...
        <ul className="p-4 space-y-4 max-h-60 overflow-y-auto">
          ...
          {basket.map((product, index) => (
            <li
              key={`${product.uniqueId}-${index}`} // Utilisation de l'ID unique du produit comme clé
