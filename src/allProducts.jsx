...
const AllProducts = () => {
  ...
  useEffect(() => {
    let filtered = products.filter((product) => {
      const matchCategory = selectedOptions.category
      ...
      <main className="flex-1 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="pt-24 pb-6 mb-8 flex items-center justify-between border-b border-gray-200">
          ...
          <div className="flex items-center">
            <Squares2X2Icon
              className="hidden lg:block h-6 w-6 text-gray-400 mr-4"
              aria-hidden="true"
            />
            <button
              type="button"
          ...
          <aside className="hidden lg:block lg:w-1/4 p-4">
            <form className="mt-4">
              ...
              {selectedOptions.category &&
                selectedOptions.category !== "accessoires" && (
                  <Disclosure
                    as="div"
